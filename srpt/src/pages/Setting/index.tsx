        ...
        <><Popconfirm placement="topLeft" title={uploadText} onConfirm={confirmUpload} okText="Yes" cancelText="No">
            ...
            <div className='setting'>
                <div className="body">
                    ...
                    <div className='settingmask'><div className='settingMask' style={{ zIndex: 1, background: 'rgba(0,0,0,.2)' }}></div><SettingComponent refresh={refresh} changeData={changeData} setChangeData={setChangeData} setting={thirdSetting} /></div>
                </div>
            </div>
        </>
    )
